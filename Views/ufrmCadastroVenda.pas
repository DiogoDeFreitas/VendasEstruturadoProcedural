...
type
  TfrmCadastroVenda = class(TfrmCadastroPai)
    ...
    frxDBDatasetItensVenda: TfrxDBDataset;
    btnImprimir: TBitBtn;
...
procedure TfrmCadastroVenda.btnImprimirClick(Sender: TObject);
begin
  inherited;
  frVenda.Variables['Cliente'] := QuotedStr(DBLookupComboBox1.Text);
